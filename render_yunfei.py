...
if __name__ == "__main__":
    ...
    parser.add_argument("--skip_train", type=bool, default=True)
    parser.add_argument("--skip_test", type=bool, default=False)
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--skip_video", type=bool, default=False)
    parser.add_argument("--configs", type=str, default='arguments/custom/default.py')
    parser.add_argument('--model_path', type=str, default="output/1080_Dance_Dunhuang_Single_f14")

    args = get_combined_args(parser)
    # add by yunfei
    args.model_path = "output/1080_Dance_Dunhuang_Single_f14"
    args.source_path = "/mnt/d/common/Datasets/PKU/part1/1080_Dance_Dunhuang_Single_f14/per_frame/000000"
    args.images = "images"
    args.eval = True
    args.llffhold = 8
    ...
    # render_sets(model, hyperparam, args.iteration, pipeline, args.skip_train, args.skip_test, args.skip_video)
