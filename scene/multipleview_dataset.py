...
class multipleview_dataset(Dataset):
    def __init__(
        ...
        self.image_paths, self.image_poses, self.image_times = self.load_images_path(cam_folder, cam_extrinsics,
                                                                                     cam_intrinsics, split)
        if split == "test":
    ...
    def load_images_path(self, cam_folder, cam_extrinsics, cam_intrinsics, split):
        ...
        for idx, key in enumerate(cam_extrinsics):
            ...
            if split == "test":
                image_range = [image_range[0], image_range[int(image_length / 3)],
