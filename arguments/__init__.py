...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self._source_path = ""
        self._model_path = ""
        # self._source_path = parser.source_path
        # self._model_path = parser.model_path
        self._images = "images"
        self._resolution = -1
    ...
    def extract(self, args):
        ...
        # g.source_path = os.path.abspath(self._source_path)
        # g.model_path = os.path.abspath(self._model_path)
        return g
